...
import management.system.veterinary.business.abstracts.DoctorServiceImpl;
...
public class DoctorController {
    ...
    public ResultData<DoctorResponse> save (@Valid @RequestBody DoctorSaveRequest doctorSaveRequest){
        ...
        this.doctorServiceImpl.save(saveDoctor);
    ...
    public ResultData<DoctorResponse> getByName(@PathVariable("name") String name){
        Doctor doctor = this.doctorServiceImpl.getByName(name);
    ...
    public ResultData<DoctorResponse> update(@Valid @RequestBody DoctorUpdateRequest doctorUpdateRequest){
        ...
        this.doctorServiceImpl.save(updateDoctor);
